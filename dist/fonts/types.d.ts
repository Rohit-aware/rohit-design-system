...
export type FontConfigInput<TFamilies extends FontFamiliesConfig, TSizes extends FontSizeConfig> = {
    families: TFamilies;
    sizes: TSizes;
};
export type StaticFontKey<TFamilies extends FontFamiliesConfig, TSizes extends FontSizeConfig> = {
...
export type FontStyleValue = Pick<TextStyle, "fontFamily" | "fontWeight" | "fontStyle" | "fontSize">;
export type DynamicFontFn = (size: number) => FontStyleValue;
export type StaticFontStyles<TFamilies extends FontFamiliesConfig, TSizes extends FontSizeConfig> = {
...
export type FontStyles<TFamilies extends FontFamiliesConfig, TSizes extends FontSizeConfig> = StaticFontStyles<TFamilies, TSizes> & DynamicFontStyles<TFamilies>;
