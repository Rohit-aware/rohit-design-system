...
export type FinalColorKeys<TUser extends ColorMap> = keyof Omit<BaseColors, keyof TUser> | keyof TUser;
export type FinalColors<TUser extends ColorMap> = ColorScaleMap<Extract<FinalColorKeys<TUser>, string>>;
...
export type ProjectThemeConfig<TUser extends ColorMap, TDark extends {
...
export type ProjectTheme<TColors extends ColorScaleMap<string>, TShadowKeys extends string = never> = {
